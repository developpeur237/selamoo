            ...
            if (!empty($smof_data) || !empty($data)) {
                ...
                switch ($value['type']) {
                    ...
                    /* case 'editor':
                      $ta_value = '';
                      $ta_value = stripslashes($smof_data[$value['id']]);
                      //$output .= '<textarea class="of-input" name="'.$value['id'].'" id="'. $value['id'] .'">'.$ta_value.'</textarea>';
                      ob_start();
                      wp_editor($ta_value, $value['id'], array(
                      'textarea_rows' => 8,
                    ...
                    case 'button':
                        ...
                        $output .= '<img src="' . DIGI_THEME_URI . '/admin/assets/images/ajax-loader.gif" alt="" style="margin-left: 5px; display: none;" />';
                        break;
                    // End nasa edit
                    //tab heading
                    case 'heading':
                    ...
                    case 'backup':
                        ...
                        $backup = of_get_options(DIGI_ADMIN_BACKUPS);
                        ...
                        $output .= '<p><strong>' . esc_html__('Last Backup : ', 'digi-theme') . '<span class="backup-log">' . $log . '</span></strong></p></div>' . "\n";
