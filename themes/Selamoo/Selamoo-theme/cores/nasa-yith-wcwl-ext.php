...
if (NASA_WISHLIST_ENABLE) :
    ...
    class DIGI_YITH_WCWL_Shortcode extends YITH_WCWL_Shortcode {
        ...
        public static function init() {
            if (!NASA_WISHLIST_NEW_VER) {
                add_shortcode('nasa_yith_wcwl_wishlist', array('DIGI_YITH_WCWL_Shortcode', 'wishlist'));
            } else {
                add_shortcode('nasa_yith_wcwl_wishlist', array('DIGI_YITH_WCWL_Shortcode', 'wishlist_new'));
            }
        }
         ...
         * 
         * @global type $yith_wcwl_is_wishlist
         * @global type $yith_wcwl_wishlist_token
         * @param type $atts
         * @param type $content
         * @return type
         */
        public static function wishlist($atts = array(), $content = null) {
            ...
            ob_start();
            $template = DIGI_CHILD_PATH . '/includes/nasa-sidebar-wishlist_content.php';
            include is_file($template) ? $template : DIGI_THEME_PATH . '/includes/nasa-sidebar-wishlist_content.php';
