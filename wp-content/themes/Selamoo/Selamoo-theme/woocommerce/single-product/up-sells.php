    ...
    <div class="related up-sell products grid margin-bottom-40">
        <div class="row">
            <div class="related-block-title large-12 columns">
                <h3 class="nasa-shortcode-title-slider"><?php esc_html_e('You may also like&hellip;', 'digi-theme'); ?></h3>
        ...
        <div class="row">
            <div class="large-12 columns">
                <div class="row group-slider">
                    <div id="nasa-slider-upsell-product" class="nasa-slider owl-carousel products-group" data-columns="<?php echo (int) $columns_desk; ?>" data-columns-small="<?php echo (int) $columns_small; ?>" data-columns-tablet="<?php echo (int) $columns_tablet; ?>" data-padding="65px" data-disable-nav="true">
                        <?php
