...
<div class="page-wrapper my-account">
    <div class="row">
        <div id="content" class="large-12 columns" role="main">
                ...
                <div class="row vertical-tabs">
                    <div class="large-3 columns">
                        <div class="account-user hide-for-small">
                            ...
                            <span class="logout-link"><a href="<?php echo esc_url($logout_url); ?>" title="<?php esc_html_e('Se déconnecter', 'digi-theme'); ?>"><?php esc_html_e('Se déconnecter', 'digi-theme'); ?></a></span>
                            <br />
                        </div>
            ...
            <?php else : ?>
                <h1 class="margin-top-20"><?php echo esc_html__('Se connecter ou Crée un compte', 'digi-theme'); ?></h1>
                <?php
                echo shortcode_exists('woocommerce_my_account') ?
                    do_shortcode('[woocommerce_my_account]') : '';
                while (have_posts()) :
