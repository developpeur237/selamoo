...
class Helpers {
	...
	public static function getDefaultSortFiles() {
		return get_user_meta( get_current_user_id(), '_njt_fbv_default_sort_files', true );
	}
	...
	public static function setDefaultSortFiles( $value ) {
		update_user_meta( get_current_user_id(), '_njt_fbv_default_sort_files', $value );
	}
