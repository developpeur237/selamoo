...
function nasa_sc_products_viewed($atts, $content = null) {
    ...
    // Optimized speed
    if ((isset($nasa_opt['enable_optimized_speed']) && $nasa_opt['enable_optimized_speed'] == 1) || (defined('NASA_PLG_CACHE_ACTIVE') && NASA_PLG_CACHE_ACTIVE)) {
        ...
        if (isset($atts['is_ajax']) && $atts['is_ajax'] == 'yes' &&
            ...
            return nasa_shortcode_text('nasa_products_viewed', $atts);
        }
...
// **********************************************************************//
add_action('init', 'nasa_register_products_viewed');
