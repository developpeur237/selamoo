...
<div class="row">
    ...
    <div class="large-9 columns rtl-right">
        <div class="nasa-accessories-wrap row">
            <!-- Current product -->
            <div class="nasa-large-5-col-1 small-6 medium-4 columns desktop-padding-left-25 desktop-padding-right-25 nasa-current-product wow fadeInUp product-item product-bought-together grid rtl-right" data-wow-duration="1s" data-wow-delay="<?php echo esc_attr($_delay); ?>ms" data-wow="fadeInUp">
                <!-- Thumbnail -->
            ...
            foreach ($accessories as $acc) :
                ...
                ?>
                <div class="nasa-large-5-col-1 small-6 medium-4 columns desktop-padding-right-25 desktop-padding-left-25 nasa-accessories-product wow fadeInUp product-item product-bought-together grid nasa-accessories-<?php echo (int) $product_id; ?> rtl-right" data-wow-duration="1s" data-wow-delay="<?php echo esc_attr($_delay); ?>ms" data-wow="fadeInUp">
                    <!-- Thumbnail -->
                    <div class="product-img">
