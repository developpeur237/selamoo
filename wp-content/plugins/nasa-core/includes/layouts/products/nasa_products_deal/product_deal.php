...
<div class="row nasa-row-deal-3">
                            ...
                            <div class="row">
                                ...
                                <div class="nasa-sc-p-img large-5 columns">
                                    <div class="images-popups-gallery">
                                        ...
                                        <div class="large-12 columns text-center nasa-sc-p-price">
    ...
    <div class="columns large-7 products nasa-sc-product-deals-grid nasa-less-left nasa-deal-right">
        ...
        <?php if ($product_grid->have_posts()) :
            ...
            ?>
            <div class="nasa-relative nasa-slide-style-product-deal">
                <?php if($arrows == 1) : ?>
                    <div class="nasa-nav-carousel-wrap nasa-nav-carousel-wrap-deal" data-id="#nasa-slider-<?php echo esc_attr($id_sc); ?>">
