...
class Nasa_Nav_Menu extends Walker_Nav_Menu {
    ...
    function start_lvl(&$output, $depth = 0, $args = array()) {
        ...
        $clss_lvl = $this->_colums ? ' small-block-grid-' . $this->_colums : '';
        $this->_colums = 0;
        $output .= '<div class="' . $class_names . '"><div class="div-sub"><ul class="sub-menu' . $clss_lvl . '">';
    }
    ...
    function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0) {
        ...
        $description = ($depth != 0) ? '' : (
            !empty($item->description) ? '<span>' . esc_attr($item->description) . '</span>' : ''
        );
