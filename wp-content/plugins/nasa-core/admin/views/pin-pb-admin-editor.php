<style type="text/css">
    .composer-switch, #wpb_visual_composer, .wp-editor-expand {
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function ($) {
        ...
        $('.wp-editor-expand').before($('#wrap-nasa-pin-pb').html());
...
<div class="container-wrap-nasa-pin-pb">
    ...
    <div class="nasa_pin_pb_image_wrap">
        <span class="nasa-wrap-relative-image">
            <img class="nasa_pin_pb_image<?php echo $no_image ? ' no-image' : ''; ?>" src="<?php echo esc_url($image_src); ?>" data-easypin_id="nasa_pin_pb" alt="" />
        </span>
