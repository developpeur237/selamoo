...
class Nasa_Walker_Nav_Menu_Edit extends Walker_Nav_Menu_Edit {
    function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        if($new_fields = Nasa_Nav_Menu_Item_Custom_Fields::get_field($item, $depth, $args))
...
function nasa_menu_item_additional_fields() {
    return array(
        'nasa_megamenu' => array(
            'name' => 'enable_mega',
            'label' => esc_html__('Enable megamenu', 'nasa-core'),
        ...
        'nasa_fullwidth' => array(
            ...
            'label' => esc_html__('Enable Fullwidth', 'nasa-core'),
        ...
        'nasa_icon' => array(
            'name' => 'icon_menu',
            'label' => esc_html__('Select icon for menu ', 'nasa-core'),
        ...
        'nasa_select_width' => array(
            'name' => 'columns_mega',
            'label' => esc_html__('Select number columns in megamenu', 'nasa-core'),
        ...
        'nasa_select_position_image' => array(
            ...
            'label' => esc_html__('Image position', 'nasa-core'),
        ...
        'nasa_select_disable_title' => array(
            ...
            'label' => esc_html__('Show menu title', 'nasa-core'),
            'container_class' => 'select-position',
            'input_type' => 'select_position',
            'values' => array(
                '0' => 'Enable',
