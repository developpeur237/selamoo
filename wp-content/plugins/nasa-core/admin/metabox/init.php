...
class cmb_Meta_Box {
    ...
    public function register_scripts() {
        ...
        if (3.5 <= $wp_version) {
            ...
            if (!NASA_CORE_IN_ADMIN) {
                ...
                wp_localize_script('wp-color-picker', 'wpColorPickerL10n', array(
                    'clear' => esc_html__('Clear', 'nasa-core'),
                    'defaultString' => esc_html__('Default', 'nasa-core'),
                    'pick' => esc_html__('Select Color', 'nasa-core'),
                    'current' => esc_html__('Current Color', 'nasa-core'),
                ));
            }
        } else {
        ...
        wp_register_script('nasa-script-metabox', NASA_CORE_PLUGIN_URL . 'admin/metabox/js/nasa-script-metabox.js');
